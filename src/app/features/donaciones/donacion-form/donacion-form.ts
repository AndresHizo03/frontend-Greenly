...
export class DonacionFormComponent implements OnInit {
  ...
  ngOnInit() {
    // Cargar combos
    this.donacionesService.listarDonantes().subscribe(d => this.donantes = d);
    this.donacionesService.listarCampanias().subscribe(c => this.campanias = c);
    this.donacionesService.listarTiposDonacion().subscribe(t => this.tiposDonacion = t);
    this.donacionesService.listarEstadosDonacion().subscribe(e => this.estadosDonacion = e);
